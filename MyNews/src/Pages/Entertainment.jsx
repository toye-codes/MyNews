...
import EntertainmentData from "../utility/EntertainmentData.json"; // Import JSON data
  ...
  return (
    <section className="container mx-auto">
      ...
      <div className="space-y-6 px-3 py-3">
        {EntertainmentData.articles.length > 0 ? (
          EntertainmentData.articles.slice(0, 6).map((article, index) => (
            <motion.div
              key={index}
