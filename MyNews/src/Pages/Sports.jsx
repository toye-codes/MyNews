...
import SportsData from "../utility/JsonData/SportsData.json";
...
const Sports = () => {
  return (
    <section className="container mx-auto">
      ...
      <h1 className="text-3xl font-bold my-4 text-center">Sports News</h1>
      <div className="space-y-6 px-3 py-3">
        {SportsData.articles.length > 0 ? (
          SportsData.articles.slice(0, 6).map((article, index) => (
            <motion.div
              key={index}
